...
def custom_to_dict(self):
    ...
    if style_val is not None:
        ...
        del d['style'] # Khaali style ko delete karega taki Telegram block na kare!
    return d
...
def save_channel_final(call):
    ...
    try:
        ...
        if color_style == "normal": color_style = "" # Normal means no color
...
def wingo_menu(call):
    ...
    try:
        ...
        # In do buttons me color nahi dena tha, isliye ab inme null nahi balki style filter ho jayega!
